...
Relational Database is the database which use relation model. relation model is a two dimension table. Data is stored in the form of rows and columns in this table. Tables connect to each other by primary key and foreign key. There are some advantage of relational database: * It's easy to understand
* The SQL statement is easy to mantipulate the database. * It's easy to maintain and reduce redundancy.
